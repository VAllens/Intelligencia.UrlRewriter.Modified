...
namespace Intelligencia.UrlRewriter.Configuration
{
    ...
    public class RewriterConfiguration : IRewriterConfiguration
    {
        ...
        internal RewriterConfiguration(IConfigurationManager configurationManager)
        {
        ...
        /// <summary>
        /// Load RewriterConfiguration Instance to File
        /// </summary>
        /// <param name="filename">Config File Path</param>
        /// <returns></returns>
